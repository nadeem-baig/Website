...
return (
            <View style={{ height: cardHeight, width: cardWidth, margin: 10, borderWidth: 0.5, borderColor: '#dddddd',borderRadius:10,elevation:3,shadowColor:'gray',shadowOffset:{width:0,height:10},shadowOpacity:1,shadowRadius:7,overflow:"hidden" }}>
                <View style={{ flex: 2 }}>
